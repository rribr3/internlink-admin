...
const Users = () => {
  ...
  const EditDialog = () => {
    ...
    }, [editFormData, selectedUser, users]);
                        ...
                        <Grid container spacing={3}>
                          <Grid item xs={12}>
                            <TextField
                              ...
                              onChange={(e) => handleFormFieldChange('university', e.target.value)}
                              variant="outlined"
                              sx={{ '& .MuiOutlinedInput-root': { borderRadius: 2 } }}
                            />
                          </Grid>
                          <Grid item xs={12} sm={6}>
                            <TextField
                              ...
                              onChange={(e) => handleFormFieldChange('major', e.target.value)}
                              variant="outlined"
                              sx={{ '& .MuiOutlinedInput-root': { borderRadius: 2 } }}
                            />
                          </Grid>
                          <Grid item xs={12} sm={6}>
                            <TextField
                              ...
                              onChange={(e) => handleFormFieldChange('degree', e.target.value)}
                              variant="outlined"
                          ...
                          <Grid item xs={12} sm={4}>
                            <TextField
                              ...
                              onChange={(e) => {
                                handleFormFieldChange('gradyear', e.target.value);
                                handleFormFieldChange('year', e.target.value);
                              }}
                              variant="outlined"
                              sx={{ '& .MuiOutlinedInput-root': { borderRadius: 2 } }}
                            />
                          ...
                          <Grid item xs={12} sm={4}>
                            <TextField
                              ...
                              onChange={(e) => handleFormFieldChange('gpa', e.target.value)}
                              variant="outlined"
                              placeholder="e.g., 3.8"
                              sx={{ '& .MuiOutlinedInput-root': { borderRadius: 2 } }}
                            />
                        ...
                        <Grid container spacing={3}>
                          <Grid item xs={12}>
                            <TextField
                              ...
                              onChange={(e) => handleFormFieldChange('skills', e.target.value)}
                              variant="outlined"
                        ...
                        <Grid container spacing={3}>
                          <Grid item xs={12} sm={6}>
                            <TextField
                              ...
                              onChange={(e) => handleFormFieldChange('linkedin', e.target.value)}
                              variant="outlined"
                          ...
                          <Grid item xs={12} sm={6}>
                            <TextField
                              ...
                              onChange={(e) => handleFormFieldChange('github', e.target.value)}
                              variant="outlined"
                        ...
                        <Grid container spacing={3}>
                          <Grid item xs={12} sm={6}>
                            <TextField
                              ...
                              onChange={(e) => handleFormFieldChange('mission', e.target.value)}
                              variant="outlined"
                          ...
                          <Grid item xs={12} sm={6}>
                            <TextField
                              ...
                              onChange={(e) => handleFormFieldChange('vision', e.target.value)}
                              variant="outlined"
